      ...
      {view === "projections" && (
        <>
            ...
            {activeChannelId && (
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(REPORT_URL(activeChannelId!), "_blank")
                  }
                >
              ...
              <CardContent>
                {loading ? (
                  ...
                  <div className="text-slate-500">
                    Insufficient historical data to form current metrics.
                  </div>
                ) : (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="border-slate-800 hover:bg-transparent">
                        ...
                        <TableHead className="text-right text-synthwave-magenta">
                          Proj. Subs
                        </TableHead>
                        <TableHead className="text-right text-synthwave-cyan">
                          Proj. Views
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                ...
                {loading ? (
                  ...
                  <div className="space-y-3">
                    <p className="text-3xl font-mono font-bold text-synthwave-purple drop-shadow-[0_0_8px_rgba(180,0,255,0.5)]">
                      $
                      {projections.estimated_monthly_revenue_low?.toLocaleString()}{" "}
                      – $
                      {projections.estimated_monthly_revenue_high?.toLocaleString()}
                    </p>
                    <p className="text-sm text-slate-400">
                      Based on $2–$8 CPM range
                    </p>
                  </div>
                )}
              </CardContent>
          ...
          <Card className="glassmorphism border-t-synthwave-cyan border-t-2 bg-slate-900/50">
            ...
            <CardContent>
              {loading ? (
                <div className="animate-pulse text-slate-500 py-6">
                  Loading chart data...
                </div>
              ) : dailyStats.length === 0 ? (
                <div className="text-slate-500 py-6 text-center">
                  No historical data yet — stats will appear once daily polling
                  is set up.
                </div>
              ) : (
